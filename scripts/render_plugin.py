...
def build_spec() -> PluginSpec:
    ...
    from cio_advisory.adapters.gcp.mcp_tool_catalog import McpToolCatalogAdapter
    from cio_advisory.agent.agent_card import agent_card_document
    ...
    return PluginSpec(
        ...
        license="Apache-2.0",
        repository="https://github.com/portable-genai/cio-advisory",
        ...
        servers={
            "cio-advisory": StdioServer(
                command="python",
                args=("-m", "cio_advisory.mcp"),
                cwd="${PLUGIN_ROOT}",
            )
        },
