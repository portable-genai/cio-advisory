...
STEPS = [
    {
        "client": 0,
        "align": False,
        "label": "Balanced client: the portfolio, and what it is short of",
        "next": "Show the cited talking points",
    },
    {
        "client": 0,
        "align": False,
        "label": "Balanced client: cited talking points against those gaps",
        "next": "Show this client's theme-by-theme alignment",
    },
    {
        "client": 0,
        "align": True,
        "label": "Balanced client: theme by theme, including the gaps this report cannot close",
        "next": "Switch to the conservative client (same house views)",
    },
    {
        "client": 1,
        "align": False,
        "label": "Conservative client: a 20 point equity gap, and the theme that would close it",
        "next": "Show the same house views, now refused",
    },
    {
        "client": 1,
        "align": False,
        "label": "Conservative client: the gap-closing theme is dropped as UNSUITABLE",
        "next": "Show this client's theme-by-theme alignment",
    },
    {
        "client": 1,
        "align": True,
        "label": "Conservative client: theme by theme",
        "next": "Show the client whose threat names one of their funds",
    },
    {
        "client": 2,
        "align": True,
        "label": "Aggressive client: real assets over its band, and the threat names the fund",
