...
- `platform`: delegate guardrail/redaction (Hrz1), house views (Hrz2), registry (Hrz3), eval (Hrz4),
  audit (Hrz5) to the shared sibling services over HTTP.
...
The build must pass the offline eval gate (merge guard) and the Hrz4 judged gate before
