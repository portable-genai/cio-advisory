...
| FAQ | For | Answers |
|---|---|---|
| [security-faq.md](security-faq.md) | AppSec / security review | authn/authz, tenancy, secrets, supply chain, the audit chain, what's in vs out of scope |
...
| [compliance-faq.md](compliance-faq.md) | Compliance / MLRO / model risk | regulatory posture, the advice boundary, PII, maker-checker, residency, model-risk evidence |
...
repo (the guardrail gateway, the governed knowledge base, the eval platform, the human-review
console, ...), the FAQ points at it and explains the boundary rather than duplicating it. See
