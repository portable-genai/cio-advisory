...
class HealthResponse(BaseModel):
    ...
    #: the bound generator calls. Derived server-side so the console never guesses. Once a
    #: request is answered, the pill shows that response's ``X-Answered-By`` instead.
