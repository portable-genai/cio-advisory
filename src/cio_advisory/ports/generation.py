"""Generation ports : LLM synthesis and public-web grounding.

Primary GCP adapters: Gemini models on the Gemini Enterprise Agent Platform
(``gemini-3.5-flash`` for talking-point synthesis, ``gemini-3.1-flash-lite`` for triage)
and the Gemini API ``google_search`` grounding tool (isolated in a grounding sub-agent
