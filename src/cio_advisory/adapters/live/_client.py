...
Loopback by default and no credentials: the point of this profile is that client
portfolio data is processed by a model running on the operator's own machine.
"""
