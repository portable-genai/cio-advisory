"""Platform ReviewRouterPort: submit the routed briefing review to Hrz7 via ``review-kit``.

Builds the review from the escalated briefing and submits it to the Hrz7 service intake
...
class PlatformReviewRouter:
    """Submit escalated advisory briefings to Hrz7 (rule R8), reusing the shared client."""
