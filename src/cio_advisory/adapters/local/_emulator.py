...
use their SDK-free in-process / SQLite path, which is the default.
...
There is no emulator for File Search / Agent Search, Gemini, Model Armor, DLP, BigQuery
or Document AI, so those adapters stay on the SDK-free workaround unconditionally.
"""
