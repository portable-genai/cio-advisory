...
the malicious test input and allows the benign one, so the blocked-path tests pass by
feeding malicious vs benign text rather than by swapping in a special fake. There is no
Google emulator for Model Armor, so this path is unconditional.
"""
