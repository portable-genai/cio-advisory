...
| **P-08** auditability / model-risk gate | Met | `eval/run_eval.py` is the offline promotion gate (groundedness, suitability accuracy, citation accuracy, no-advice safety); the hosted Cloud Build check runs it; Hrz4 is the judged pre-promotion gate (R5). |
